...
public:
	...
	{
		ID3D11DeviceContext* ctx = reinterpret_cast<ID3D11DeviceContext*>(fo4cs::GetRendererData()->context);
...
public:
	...
	{
		ID3D11Device* device = reinterpret_cast<ID3D11Device*>(fo4cs::GetRendererData()->device);
