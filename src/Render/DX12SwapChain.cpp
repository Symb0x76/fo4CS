...
void DX12SwapChain::CreateSwapChain(IDXGIFactory4 *a_dxgiFactory, DXGI_SWAP_CHAIN_DESC a_swapChainDesc)
{
    ...
    // needs a Streamline-owned present path that nothing here establishes. Which
    ...
    logger::info(
        ...
        swapChainDesc.Width, swapChainDesc.Height, static_cast<uint32_t>(swapChainDesc.Format), swapChainDesc.Flags,
        useFidelityFXSwapChain ? "FidelityFX" : "native", upscaling->UsesFSRFrameGeneration(),
