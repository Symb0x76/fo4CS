...
function(fo4cs_configure_target target)
    ...
    # Generated headers (Core/FeatureVersions.h). Feature.h includes it, and
    # Feature.h is pulled in across the whole feature layer, so every target sees it.
    if(FO4CS_GENERATED_INCLUDE_DIR)
        target_include_directories("${target}" PRIVATE ${FO4CS_GENERATED_INCLUDE_DIR})
    endif()
...
# Compatibility shim for the older call shape used on this branch, which passed a
# target that the function never used. Prefer fo4cs_mark_third_party_sources.
function(fo4cs_add_imgui_sources target)
    fo4cs_mark_third_party_sources(${ARGN})
endfunction()
