...
# The MSVC flag set and the ImGui source marking moved to Fo4csTargets.cmake
# (fo4cs_configure_target / fo4cs_mark_third_party_sources), shared with `main`.
# /sdl- /GS- /guard:cf- there are deliberate: mod plugins are local-run code where
# the CFG guard overhead on the /O2 /arch:AVX hot paths is not worth it. Keep them
# off unless a security requirement changes that tradeoff.
